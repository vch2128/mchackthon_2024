...
#         "sender_id": "0445782eb4e4476aa1d3802a1df4f462"
#         }'

# create emo msg to specific receiver
curl -X POST "http://localhost:8001/api/emomsg_to" \
    -H "Content-Type: application/json" \
    -d '{  
        "content": "i want to go home immediately",
        "sender_id": "0445782eb4e4476aa1d3802a1df4f462",
        "rcvr_id": ["7144dcaa96534cc6bf35b93efa8b7ee4"]
        }'
...
# for testing
# {"id":"0445782eb4e4476aa1d3802a1df4f462","name":"New_Employee_48","account":"ozpgQxPy","password":"$2b$1PCeW4Y.mqC.CAPCRxA/NGezOnfVGgaoh9sUfF2MKfi","department":"Manufacturing","age":29,"position":"Analyst","